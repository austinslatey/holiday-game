...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "cave",
      "https://content.codecademy.com/courses/learn-phaser/Cave%20Crisis/cave_background.png"
    );
    this.load.image(
      "platform",
      "https://content.codecademy.com/courses/learn-phaser/Cave%20Crisis/platform.png"
    );
    ...
    this.load.spritesheet(
      "snowman",
      "https://content.codecademy.com/courses/learn-phaser/Cave%20Crisis/snowman.png",
      { frameWidth: 50, frameHeight: 70 }
    );
    this.load.spritesheet(
      "exit",
      "https://content.codecademy.com/courses/learn-phaser/Cave%20Crisis/cave_exit.png",
  ...
  create() {
    ...
    gameState.player = this.physics.add.sprite(50, 500, "codey").setScale(0.8);
  ...
  update() {
    if (gameState.active) {
      ...
      if (
        (gameState.cursors.space.isDown || gameState.cursors.up.isDown) &&
